...
class TestUser(unittest.TestCase):
    ...
    def setUp(self):
        ...
        '''
        self.new_user = User("Nasiboyussuf","Instagram","jiko")# Instance of class User

    def test_init(self):
        '''
        Test case to test if object is initialised properly
        '''
        self.assertEqual(self.new_user.username, "Nasiboyussuf")
        self.assertEqual(self.new_user.account, "Instagram")
        self.assertEqual(self.new_user.password, "jiko")
    ...
    def test_save_multiple_users(self):
        ...
        self.new_user.save_user()
        test_user = User("Moha Sanchez", "Facebook", "jiko")
        test_user.save_user()
